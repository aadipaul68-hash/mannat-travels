...
import { tours, inquiries } from '../db/schema.ts';
import { eq, desc } from 'drizzle-orm';

/**
 * Builds an Express app containing every /api route. It is shared by the local
 * dev server (server.ts) and the Vercel serverless function (api/index.ts) so
 * the API behaves identically in development and production.
 */
